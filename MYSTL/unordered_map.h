...
// 这个头文件包括两个模板类： unordered_map 和 unordered_multi_map
// 与map 和 ordered_map 不同， 容器内的元素不会自动排序
...
// 参数一代表键值类型， 参数二代表实值类型， 参数三代表哈希函数， 缺省使用mystl::hash
// 参数四代表键值比较方式， 缺省使用mystl::equal_to
